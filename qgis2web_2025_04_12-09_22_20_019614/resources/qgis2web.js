...
map.getView().fit([-9150280.925725, -1193753.015936, -8289309.050379, -652810.837862], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">GEOLOGÍA DEL DEPARTAMENTO - LA LIBERTAD</h2>';
        return titleElement;
    })(),
